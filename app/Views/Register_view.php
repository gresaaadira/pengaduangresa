            ...
            <div class="col-lg-12">
              <div class="p-5">
                ...
                <form class="user" method="post" action="saveregister">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" name="nama_masyarakat" id="nama_masyarakat" placeholder="Nama" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="password" name="password2" class="form-control form-control-user" id="password" placeholder="Ulangi Password" required>
                    </div>
                  </div>
