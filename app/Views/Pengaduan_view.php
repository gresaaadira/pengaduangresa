                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if (!empty(session('level')) && session('level') != 'masyarakat') {
                                if ($row['status'] == '0') {
                                ?>
                                    <a href="#" class="btn btn-primary" href="#" data-toggle="modal" data-target="#modalTanggapan" data-pengaduan="<?= $row['id_pengaduan'] ?>">Tanggapi</a>
                            <?php
                                } else {
                                    ?>
                ...
                <form action="/tambahpengaduan" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="background: green !important" class="warna">
                        </div>
                    </div>
             ...
             <div class="modal-dialog">
                <div class="modal-content">
                     ...
                     <form action="tanggapi" method="post">
                        ...
                        <div class="modal-footer">
                             <button type="submit" class="btn btn-success" id="btssiman">Simpan</button>
                         </div>
                     </form>
                     </div>
                </div>
...
<script>
     $(document).ready(function() {
        $('#modalTanggapan').on('show.bs.modal', function(e) {
            var button = $(e.relatedRarget);
             var data = button.data('pengaduan');
             var aduan = buutton.data('aduan');
