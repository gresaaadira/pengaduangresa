...
$routes->post('getTanggapan', 'TanggapanController::tanggapan');
$routes->post('pengaduan', 'PengaduanController::index');

$routes->post('/tambahpengaduan', 'PengaduanController::simpan');
$routes->post('pengaduan/hapus/(:segment)','PengaduanController::hapus/$1');

$routes->post('/profil', 'LoginController::login');

$routes->post('login', 'LoginController::lihatprofil');
...
$routes->add('/pengaduan','PengaduanController::index');
